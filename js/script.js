...
function listSprites(console, game) {
  let sprites_ul = $("<ul>");
  let sprite_li = $("<li>");
  let sprite_a = $("<a>");
...
function listGames(console) {
  ...
  for (let game in consoleGames) {
    ...
    if (game != "") {
      ...
      game_li.append(listSprites(console, game));
...
function listConsoles() {
  ...
  for (let console in consoles) {
    ...
    if (console != "") {
      ...
      console_li.append(listGames(console));
    ...
    if(console != "") {
      ...
      if(game != "") {
        ...
        if(sprite != "") {
          ...
          let sprites_ul = listSprites(console, game);
          $("body").append(sprites_ul);
        }
      } else {
        let games_ul = listGames(console);
